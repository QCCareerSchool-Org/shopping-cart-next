...
const courseSlug = 'how-to-groom-a-golden-retriever';
...
const HowToGroomAGoldenRetrieverCheckoutPage: PageComponent = async ({ searchParams }) => {
  const date = await getDate(searchParams?.date);
  return <PpaCart date={date} course={course} />;
};

export default HowToGroomAGoldenRetrieverCheckoutPage;
