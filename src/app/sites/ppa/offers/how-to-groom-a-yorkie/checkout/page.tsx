...
const courseSlug = 'how-to-groom-a-yorkie';
...
const HowToGroomAYorkieCheckoutPage: PageComponent = async ({ searchParams }) => {
  const date = await getDate(searchParams?.date);
  return <PpaCart date={date} course={course} />;
};

export default HowToGroomAYorkieCheckoutPage;
