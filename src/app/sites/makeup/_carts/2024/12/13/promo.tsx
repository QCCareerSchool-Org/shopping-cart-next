...
import { Makeup20241213Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#440204';
...
export const Makeup20241213Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Makeup20241213Modal show={showPopup} onHide={handleClick} />
