...
import { Makeup20251226Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#090401';
...
export const Makeup20251226Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Makeup20251226Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
