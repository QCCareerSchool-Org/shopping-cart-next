...
import { Makeup20250407Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#e5dcf7';
...
export const Makeup20250407Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Makeup20250407Modal show={showPopup} onHide={handleClick} />
