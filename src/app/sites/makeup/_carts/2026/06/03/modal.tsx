...
export const Makeup20260603Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260603ModalHeading />}
      left={<Makeup20260603ModalLeft />}
      right={<Makeup20260603ModalRight />}
      headerAside={<Makeup20260603ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260603ModalHeading: FC = () => (
...
const Makeup20260603ModalRight: FC = () => (
