...
export const Makeup20260826Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260826ModalHeading />}
      left={<Makeup20260826ModalLeft />}
      right={<Makeup20260826ModalRight />}
      headerAside={<Makeup20260826ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260826ModalHeading: FC = () => (
...
const Makeup20260826ModalOffer: FC = () => (
...
const Makeup20260826ModalLeft: FC = () => (
  <>
    <div>
...
const Makeup20260826ModalRight: FC = () => (
  <div>
