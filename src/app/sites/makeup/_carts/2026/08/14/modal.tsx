...
export const Makeup20260814Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260814ModalHeading />}
      left={<Makeup20260814ModalLeft />}
      right={<Makeup20260814ModalRight />}
      headerAside={<Makeup20260814ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260814ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="mb-0">Enroll in <strong>Master Makeup Artistry</strong> today and get both the <strong>Skincare Course + Pro Makeup Workshop FREE</strong>.</p>
  </div>
);

const Makeup20260814ModalOffer: FC = () => (
  <div className="position-relative z-1 text-center text-lg-end bg-light p-3 rounded-3 border mx-auto" style={{ maxWidth: 300 }}>
    <div className="fs-2 fw-bold text-start" style={{ color: '#0A0F3D', lineHeight: 1.1 }}>+ Bonus</div>
    <div className="fs-2 fw-bold text-start" style={{ color: '#0A0F3D', lineHeight: 1.1 }}>Mystery Gift</div>
  </div>
);

const Makeup20260814ModalLeft: FC = () => (
  <>
    <div>
      <h4 className="mb-2">Get Two Professional Courses FREE</h4>
      ...
      <p><strong>Transform your career and learn to:</strong></p>
...
const Makeup20260814ModalRight: FC = () => (
  <div>
