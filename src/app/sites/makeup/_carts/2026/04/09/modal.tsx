...
export const Makeup20260409Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton><strong>A makeup career that grows with you!</strong></Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future and get certified. Enroll in <strong>Master Makeup Artistry</strong> and get QC's <strong>Pro Makeup Workshop</strong> FREE—so you can build your skills, your confidence, and your opportunities.</p>
