...
export const Makeup20260121Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton><strong>Take Charge of Your Makeup Career</strong></Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future. Enroll in <strong>Master Makeup Artistry</strong> and get QC&apos;s <strong>Pro Makeup Workshop FREE</strong>&mdash;so you can build your skills, your confidence, and your opportunities.</p>
      <p>This three-part masterclass led by celebrity makeup artist Nathan Johnson is designed to build on your foundational training and take your career to the next level! You'll learn:</p>
      <ul>
