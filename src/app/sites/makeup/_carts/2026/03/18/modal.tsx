...
export const Makeup20260318Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton><strong>Turn Passion into Proof!</strong></Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future and get certified. Enroll in <strong>Master Makeup Artistry</strong> and get QC's <strong>Pro Makeup Workshop FREE</strong>—so you can build your skills, your confidence, and your opportunities.</p>
