...
import { Makeup20260923Promo } from './promo';
...
export const Makeup20260923: FC<Props> = ({ date, period }) => (
  <>
    <Makeup20260923Promo date={date} period={period} />
    <Form
      date={date}
