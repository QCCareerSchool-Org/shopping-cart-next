...
export const Makeup20260923Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260923ModalHeading />}
      left={<Makeup20260923ModalLeft />}
      right={<Makeup20260923ModalRight />}
      headerAside={<Makeup20260923ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260923ModalHeading: FC = () => (
...
const Makeup20260923ModalOffer: FC = () => (
...
const Makeup20260923ModalLeft: FC = () => (
  <>
    <div>
...
const Makeup20260923ModalRight: FC = () => (
  <div>
