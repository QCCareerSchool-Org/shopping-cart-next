...
export const Makeup20260909Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260909ModalHeading />}
      left={<Makeup20260909ModalLeft />}
      right={<Makeup20260909ModalRight />}
      headerAside={<Makeup20260909ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260909ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    <div className="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill small fw-bold text-uppercase mb-3" style={{ backgroundColor: 'rgba(13, 110, 253, 0.1)', color: '#0A0F3D', border: '1px solid rgba(13, 110, 253, 0.2)' }}>
      <FaMagic /> Unlock 2 Professional Makeup Certifications
    </div>
    <h2 className="fs-2 fw-bolder mb-2" style={{ color: '#0A0F3D' }}>A Makeup Career that Grows With You</h2>
    <p className="mb-0">Enroll in <strong>Master Makeup Artistry</strong> today and receive a 2nd course <strong> FREE</strong>!</p>
  </div>
);

const Makeup20260909ModalOffer: FC = () => (
...
const Makeup20260909ModalLeft: FC = () => (
  <>
    <div>
...
const Makeup20260909ModalRight: FC = () => (
  <div>
