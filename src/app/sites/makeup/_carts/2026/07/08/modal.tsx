...
export const Makeup20260708Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260708ModalHeading />}
      left={<Makeup20260708ModalLeft />}
      right={<Makeup20260708ModalRight />}
      headerAside={<Makeup20260708ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260708ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="mb-0">Enroll in Master <strong>Makeup Artistry</strong> today and get the <strong>Skincare Course</strong> FREE.</p>
  </div>
);

const Makeup20260708ModalOffer: FC = () => (
...
const Makeup20260708ModalLeft: FC = () => (
  <>
    <div>
      <h3 className="h4 mb-3">Get a FREE Skincare Course</h3>
...
const Makeup20260708ModalRight: FC = () => (
