...
export const Makeup20260722Modal: FC<Props> = props => {
  ...
  return (
    <PromoModal
      ...
      heading={<Makeup20260722ModalHeading />}
      left={<Makeup20260722ModalLeft />}
      right={<Makeup20260722ModalRight />}
      headerAside={<Makeup20260722ModalOffer />}
      footerMessage={<>Start your journey today for only <span className="text-primary">$49</span>.</>}
    />
  );
};

const Makeup20260722ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="mb-0">Enroll in Master <strong>Makeup Artistry</strong> today and get the <strong>Pro Makeup Workshop</strong> FREE.</p>
  </div>
);

const Makeup20260722ModalOffer: FC = () => (
...
const Makeup20260722ModalRight: FC = () => (
  <div>
