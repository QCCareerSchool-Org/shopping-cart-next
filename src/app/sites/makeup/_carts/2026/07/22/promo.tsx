...
import { Hero20260722 } from './hero';
import { Makeup20260722Modal } from './modal';
...
export const Makeup20260722Promo: FC<Props> = ({ date, period }) => {
