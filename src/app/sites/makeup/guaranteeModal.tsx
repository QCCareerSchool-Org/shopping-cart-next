...
export const GuaranteeModal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    ...
    <ModalBody>
      <p>We stand behind our quality courses. That's why we offer a full money-back guarantee. From the date you enroll, you have 14 days to review the course materials.</p>
