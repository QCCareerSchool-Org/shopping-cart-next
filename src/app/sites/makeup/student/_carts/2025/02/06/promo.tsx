...
import { MakeupStudent20250206Modal } from './modal';
...
export const MakeupStudent20250206Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20250206Modal show={showPopup} onHide={handleClick} />
