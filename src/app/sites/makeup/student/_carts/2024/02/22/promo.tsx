...
import { MakeupStudent20240222Modal } from './modal';
...
export const MakeupStudent20240222Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20240222Modal show={showPopup} onHide={handleClick} />
