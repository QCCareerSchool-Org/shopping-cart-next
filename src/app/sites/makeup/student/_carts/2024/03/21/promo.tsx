...
import { MakeupStudent20240321Modal } from './modal';
...
export const MakeupStudent20240321Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20240321Modal show={showPopup} onHide={handleClick} />
