...
import { MakeupStudent20241226Modal } from './modal';
...
export const MakeupStudent20241226Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20241226Modal show={showPopup} onHide={handleClick} />
