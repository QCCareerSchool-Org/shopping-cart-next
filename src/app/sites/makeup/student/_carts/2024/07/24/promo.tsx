...
import { MakeupStudent20240724Modal } from './modal';
...
export const MakeupStudent20240724Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20240724Modal show={showPopup} onHide={handleClick} />
