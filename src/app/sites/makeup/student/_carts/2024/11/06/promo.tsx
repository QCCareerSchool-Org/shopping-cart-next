...
import { MakeupStudent20241106Modal } from './modal';
...
export const MakeupStudent20241106Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20241106Modal show={showPopup} onHide={handleClick} />
