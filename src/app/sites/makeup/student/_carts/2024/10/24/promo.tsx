...
import { MakeupStudent20241024Modal } from './modal';
...
export const MakeupStudent20241024Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20241024Modal show={showPopup} onHide={handleClick} />
