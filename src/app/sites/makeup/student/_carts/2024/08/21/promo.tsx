...
import { MakeupStudent20240821Modal } from './modal';
...
export const MakeupStudent20240821Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20240821Modal show={showPopup} onHide={handleClick} />
