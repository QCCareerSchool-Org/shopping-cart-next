...
import { MakeupStudent20240925Modal } from './modal';
...
export const MakeupStudent20240925Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <MakeupStudent20240925Modal show={showPopup} onHide={handleClick} />
