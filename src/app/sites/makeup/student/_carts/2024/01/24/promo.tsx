...
export const MakeupStudent20240124Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Modal show={showPopup} onHide={handleClick}>
        ...
        <Modal.Body>
          <p className="mb-0">Until January 31st, enroll in any new course and get an extra $50 off plus a Sonia Kashuk brush set!</p>
        </Modal.Body>
      </Modal>
