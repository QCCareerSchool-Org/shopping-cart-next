...
export const AllAccessModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <h2 className={`fs-2 fw-bolder ${styles['text-dark-blue']} mb-2`}>Everything You Need to Launch a Full-Service Design Business</h2>
    <p className="text-secondary mb-0">Enroll in the All-Access Program and get complete access to nine QC Design School Courses..</p>
  </div>
);
...
const features = [
  ...
  },
  {
    ...
    description: 'Graduate with up to ten industry-recognized certifications, including the Elite Design Professional Certification, to build credibility and attract clients.',
  },
  {
    icon: <FaChartLine className="fs-4 text-primary" />,
    title: 'Business Training Built In',
    description: 'Each course provides strategies and mentorship to help you confidently launch, market, and grow your event services.',
  },
];
