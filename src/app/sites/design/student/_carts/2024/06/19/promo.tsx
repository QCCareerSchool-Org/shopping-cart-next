...
import { DesignStudent20240619Modal } from './modal';
...
export const DesignStudent20240619Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <DesignStudent20240619Modal show={showPopup} onHide={handleClick} />
