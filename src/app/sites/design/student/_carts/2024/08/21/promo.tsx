...
import { DesignStudent20240821Modal } from './modal';
...
export const DesignStudent20240821Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <DesignStudent20240821Modal show={showPopup} onHide={handleClick} />
