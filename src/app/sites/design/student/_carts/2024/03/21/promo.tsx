...
import { DesignStudent20240321Modal } from './modal';
...
export const DesignStudent20240321Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <DesignStudent20240321Modal show={showPopup} onHide={handleClick} />
