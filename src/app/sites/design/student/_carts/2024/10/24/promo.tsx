...
import { DesignStudent20241024Modal } from './modal';
...
export const DesignStudent20241024Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <DesignStudent20241024Modal show={showPopup} onHide={handleClick} />
