...
import { DesignStudent20240420Modal } from './modal';
...
export const DesignStudent20240420Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <DesignStudent20240420Modal show={showPopup} onHide={handleClick} />
