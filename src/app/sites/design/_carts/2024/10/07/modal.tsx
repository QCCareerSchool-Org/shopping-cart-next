...
export const Design20241007Modal: FC<Props> = props => {
  return (
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Start Your Design Career</Modal.Header>
      <Modal.Body>
        <p>For a limited time, enroll in any design course and <strong>get a second course FREE!</strong> This is the perfect opportunity to specialize in your design training and become a certified expert. Plus, you can get started with a deposit of just $75. Don't miss out on this amazing offer!</p>
        <hr />
