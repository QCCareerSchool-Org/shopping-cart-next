...
export const Design20250911Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    ...
    <Modal.Body>
      ...
      <p>Prefer over time? Save up to $150 with our monthly installment plan. This is your chance to launch your design career with our biggest savings ever. Act now before this offer is gone!</p>
