...
import { Design20250225Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#3e332b';
...
export const Design20250225Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Design20250225Modal show={showPopup} onHide={handleClick} />
