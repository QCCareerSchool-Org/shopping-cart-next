...
export const Design20250206Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any design course and get a second course free. You'll also get {discount} off your tutition! This is the perfect opportunity to specialize in your design training and become a certified expert.</p>
        <hr />
