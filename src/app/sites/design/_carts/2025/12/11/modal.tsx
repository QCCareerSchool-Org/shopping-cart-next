...
export const Design20251211Modal: FC<Props> = props => {

  return (
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Start Your Design Career</Modal.Header>
      <Modal.Body>
        <p>For a limited time, enroll in any design course and get a second course FREE! Start today and become a certified expert in under 3 months.</p>
        <hr />
