...
import { Design20250620Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#131f11';
...
export const Design20250620Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Design20250620Modal show={showPopup} onHide={handleClick} />
