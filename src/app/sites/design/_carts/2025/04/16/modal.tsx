...
export const Design20250416Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any design course and get a second course FREE plus get an extra {discount} off! This is the perfect opportunity to specialize in your design training and become a certified expert.</p>
        <hr />
