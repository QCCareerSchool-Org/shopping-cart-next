...
export const Design20250723Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    ...
    <Modal.Body>
      <p>For a limited time, enroll in any design course and get a second course FREE, plus $100 off tuition! This is the perfect opportunity to specialize in your design training and become a certified expert.</p>
      <hr />
