...
import { Design20260422Promo } from './promo';
...
export const Design20260422: FC<Props> = ({ date, period }) => {
  return (
    <>
      <Design20260422Promo date={date} period={period} />
      <Form
        date={date}
