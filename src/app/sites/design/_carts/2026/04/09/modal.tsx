...
export const Design20260409Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton>Design a future that grows with you!</Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future and get certified. For a limited time, enroll in any design course and get a second course FREE. Start today and become a certified design expert in under 3 months.</p>
      <hr />
