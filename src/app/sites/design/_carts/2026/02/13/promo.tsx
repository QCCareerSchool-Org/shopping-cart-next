...
import { Design20260213Modal } from './modal';
...
export const Design20260213Promo: FC<Props> = ({ date, promotionPeriod }) => {
  ...
  return (
    <>
      ...
      <Design20260213Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
