...
export const Design20260204Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton>Take Charge of Your Future in Design</Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future. For a limited time, enroll in any design course and get a second course FREE.</p>
      <hr />
