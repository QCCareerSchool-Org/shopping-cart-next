...
import { Design20260204Modal } from './modal';
...
export const Design20260204Promo: FC<Props> = ({ date, promotionPeriod }) => {
  ...
  return (
    <>
      ...
      <Design20260204Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
