...
import { Hero20260304 } from './hero';
import { Design20260304Modal } from './modal';
...
export const Design20260304Promo: FC<Props> = ({ date, period }) => {
