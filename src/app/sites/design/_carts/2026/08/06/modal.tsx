...
export const Design20260806Modal: FC<Props> = props => {
  return (
    <PromoModal
      show={props.show}
      onHide={props.onHide}
      heading={<Design20260806ModalHeading />}
      left={<Design20260806ModalLeft />}
      right={<Design20260806ModalRight />}
      headerAside={<Design20260806ModalOffer />}
...
const Design20260806ModalHeading: FC = () => {
  return (
...
const Design20260806ModalOffer: FC = () => (
...
const Design20260806ModalLeft: FC = () => (
...
const Design20260806ModalRight: FC = () => (
  <>
