...
export const Design20260826Modal: FC<Props> = props => {
  return (
    <PromoModal
      show={props.show}
      onHide={props.onHide}
      heading={<Design20260826ModalHeading />}
      left={<Design20260826ModalLeft />}
      right={<Design20260826ModalRight />}
      headerAside={<Design20260826ModalOffer />}
...
const Design20260826ModalHeading: FC = () => {
  return (
...
const Design20260826ModalOffer: FC = () => (
...
const Design20260826ModalLeft: FC = () => (
...
const Design20260826ModalRight: FC = () => (
  <>
