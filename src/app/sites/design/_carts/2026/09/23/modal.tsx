...
import BooksImage from '../../08/26/design-book-portfolio-image-full.jpg';
...
export const Design20260923Modal: FC<Props> = props => {
  return (
    <PromoModal
      show={props.show}
      onHide={props.onHide}
      heading={<Design20260923ModalHeading />}
      left={<Design20260923ModalLeft />}
      right={<Design20260923ModalRight />}
      headerAside={<Design20260923ModalOffer />}
...
const Design20260923ModalHeading: FC = () => {
  return (
...
const Design20260923ModalOffer: FC = () => (
...
const Design20260923ModalLeft: FC = () => (
...
const Design20260923ModalRight: FC = () => (
  <>
