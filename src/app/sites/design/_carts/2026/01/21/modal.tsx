...
export const Design20260121Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>This is your moment to invest in your future. For a limited time, enroll in any design course and get a second course FREE, plus an extra {discount} OFF your tuition.</p>
        <hr />
