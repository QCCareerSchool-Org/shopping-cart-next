  ...
  return (
    <header className="text-white" style={{ backgroundColor }}>
      <div className="container py-3 py-sm-4">
        <div className="row">
          <div className="col-9 col-sm-12 text-start text-sm-center"><a href="https://www.qcpetstudies.com/"><Image src={Logo as StaticImageData} className="img-fluid" alt="QC Makeup Academy" style={{ height: 32 }} /></a></div>
