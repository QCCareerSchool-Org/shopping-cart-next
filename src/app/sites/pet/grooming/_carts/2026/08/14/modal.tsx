...
export const Grooming20260814Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Grooming20260814ModalHeading />}
    left={<Grooming20260814ModalLeft />}
    right={<Grooming20260814ModalRight />}
    headerAside={<Grooming20260814ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Grooming20260814ModalHeading: FC = () => (
...
const Grooming20260814ModalOffer: FC = () => (
...
const Grooming20260814ModalLeft: FC = () => (
  <Grooming20260814ModalCourses />
);
...
const Grooming20260814ModalCourses: FC = () => (
  <div>
