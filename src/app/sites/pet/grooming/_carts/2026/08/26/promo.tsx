...
import { Grooming20260826Modal } from './modal';
...
export const Grooming20260826Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Grooming20260826Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
