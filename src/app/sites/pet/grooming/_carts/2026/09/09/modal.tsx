...
export const Grooming20260909Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Grooming20260909ModalHeading />}
    left={<Grooming20260909ModalLeft />}
    right={<Grooming20260909ModalRight />}
    headerAside={<Grooming20260909ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Grooming20260909ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="text-secondary mb-0">Enroll in Dog Grooming and save an extra $300 on your tuition!</p>
  </div>
);

const Grooming20260909ModalOffer: FC = () => (
...
const Grooming20260909ModalLeft: FC = () => (
  <Grooming20260909ModalCourses />
);

const Grooming20260909ModalRight: FC = () => (
  <div>
...
const Grooming20260909ModalCourses: FC = () => (
  <div>
