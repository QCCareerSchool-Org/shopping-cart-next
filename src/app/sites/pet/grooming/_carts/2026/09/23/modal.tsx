...
export const Grooming20260923Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Grooming20260923ModalHeading />}
    left={<Grooming20260923ModalLeft />}
    right={<Grooming20260923ModalRight />}
    headerAside={<Grooming20260923ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Grooming20260923ModalHeading: FC = () => (
...
const Grooming20260923ModalOffer: FC = () => (
...
const Grooming20260923ModalLeft: FC = () => (
  <Grooming20260923ModalCourses />
);

const Grooming20260923ModalRight: FC = () => (
  <div>
...
const Grooming20260923ModalCourses: FC = () => (
  <div>
