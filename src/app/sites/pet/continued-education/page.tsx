...
import { PetContinuedEducationPromo } from './promo';
...
const PetContinuedEducationPage: PageComponent = ({ searchParams }) => {
  const date = getDate(searchParams.date);

  return (
    <>
      <PetContinuedEducationPromo />
      <Form
        date={date}
...
export default PetContinuedEducationPage;
