...
export const DynamicMessage: FC = () => {
  ...
  const discount = priceState?.currency.code === 'GBP' ? '£415' : '$500';
  ...
  if (!coursesState.selected.includes('DT')) {
    return <DynamicCourseAlert variant="warning">Select the <strong>Dog Training</strong> course to get {discount} off your tuition</DynamicCourseAlert>;
  }
