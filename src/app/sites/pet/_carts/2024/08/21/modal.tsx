...
export const Pet20240821Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>Enroll in any pet course and get {discount} off your tuition! Choose from in-demand professions like grooming, training, or dog daycare services.</p>
        <hr />
