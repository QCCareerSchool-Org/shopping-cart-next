...
export const Pet20260506Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260506ModalHeading />}
    left={<Pet20260506ModalLeft />}
    right={<Pet20260506ModalRight />}
    headerAside={<Pet20260506ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Pet20260506ModalHeading: FC = () => (
...
const Pet20260506ModalOffer: FC = () => (
...
const Pet20260506ModalLeft: FC = () => (
  <Pet20260506ModalCourses />
);

const Pet20260506ModalRight: FC = () => (
  <>
    <Pet20260506ModalFeatures />
...
const Pet20260506ModalCourses: FC = () => (
  <div>
...
const Pet20260506ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
