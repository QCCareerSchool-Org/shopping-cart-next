...
export const Pet20260814Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260814ModalHeading />}
    left={<Pet20260814ModalLeft />}
    right={<Pet20260814ModalRight />}
    headerAside={<Pet20260814ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Pet20260814ModalHeading: FC = () => (
...
const Pet20260814ModalOffer: FC = () => (
...
const Pet20260814ModalLeft: FC = () => (
  <Pet20260814ModalCourses />
);

const Pet20260814ModalRight: FC = () => (
  <>
    <Pet20260814ModalFeatures />
...
const Pet20260814ModalCourses: FC = () => (
  <div>
...
const Pet20260814ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
