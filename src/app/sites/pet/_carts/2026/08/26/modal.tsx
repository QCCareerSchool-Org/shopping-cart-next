...
export const Pet20260826Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260826ModalHeading />}
    left={<Pet20260826ModalLeft />}
    right={<Pet20260826ModalRight />}
    headerAside={<Pet20260826ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Pet20260826ModalHeading: FC = () => (
...
const Pet20260826ModalOffer: FC = () => (
...
const Pet20260826ModalLeft: FC = () => (
  <Pet20260826ModalCourses />
);

const Pet20260826ModalRight: FC = () => (
  <>
    <Pet20260826ModalFeatures />
...
const Pet20260826ModalCourses: FC = () => (
  <div>
...
const Pet20260826ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
