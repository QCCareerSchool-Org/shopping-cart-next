...
export const Pet20260806Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260806ModalHeading />}
    left={<Pet20260806ModalLeft />}
    right={<Pet20260806ModalRight />}
    headerAside={<Pet20260806ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Pet20260806ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="text-secondary mb-0">Enroll in any pet care course and get a 2nd course FREE!</p>
  </div>
);

const Pet20260806ModalOffer: FC = () => (
  <div className="position-relative z-1 text-center text-lg-end bg-light p-3 rounded-3 border mx-auto" style={{ maxWidth: 300 }}>
    <div className="fs-2 fw-bold" style={{ color: '#0A0F3D', lineHeight: 1.1 }}>+ FREE First Aid Training</div>
  </div>
);

const Pet20260806ModalLeft: FC = () => (
  <Pet20260806ModalCourses />
);

const Pet20260806ModalRight: FC = () => (
  <>
    <Pet20260806ModalFeatures />
...
const Pet20260806ModalCourses: FC = () => (
  <div>
...
const Pet20260806ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
