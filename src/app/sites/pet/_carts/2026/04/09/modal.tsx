...
export const Pet20260409Modal: FC<Props> = props => {
  const priceState = usePriceState();
  const discount = priceState?.currency.code === 'GBP' ? '£400' : '$400';

  return (
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Start a Career in Pet Care Today!</Modal.Header>
      <Modal.Body>
        <p>This is your moment to invest in your future and get certified. For a limited time, you can enroll in any pet care course and save {discount} on tuition, or save even more when you pay in full.</p>
        <hr />
