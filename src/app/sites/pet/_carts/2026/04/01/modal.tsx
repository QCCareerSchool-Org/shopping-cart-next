...
export const Pet20260401Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton>Start Your Pet Care Career</Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future. For a limited time, you can enroll in any pet care course and get a second course FREE.</p>
      <hr />
