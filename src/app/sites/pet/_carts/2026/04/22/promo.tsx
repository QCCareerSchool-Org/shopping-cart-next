...
import { Pet20260422Modal } from './modal';
...
export const Pet20260422Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Pet20260422Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
