...
import { Pet20260107Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#1C9697';
...
export const Pet20260107Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Pet20260107Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
