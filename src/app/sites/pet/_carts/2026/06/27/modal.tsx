...
export const Pet20260627Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260627ModalHeading />}
    left={<Pet20260627ModalLeft />}
    right={<Pet20260627ModalRight />}
    headerAside={<Pet20260627ModalOffer />}
...
const Pet20260627ModalOffer: FC = () => (
...
const Pet20260627ModalLeft: FC = () => (
  <Pet20260627ModalCourses />
);

const Pet20260627ModalRight: FC = () => (
  <>
    <Pet20260627ModalFeatures />
...
const Pet20260627ModalCourses: FC = () => (
  <div>
...
const Pet20260627ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
