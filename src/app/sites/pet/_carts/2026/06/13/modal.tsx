...
export const Pet20260613Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Pet20260613ModalHeading />}
    left={<Pet20260613ModalLeft />}
    right={<Pet20260613ModalRight />}
    headerAside={<Pet20260613ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$99</span>.</>}
  />
);

const Pet20260613ModalHeading: FC = () => (
...
const Pet20260613ModalLeft: FC = () => (
  <Pet20260613ModalCourses />
);

const Pet20260613ModalRight: FC = () => (
  <>
    <Pet20260613ModalFeatures />
...
const Pet20260613ModalCourses: FC = () => (
  <div>
...
const Pet20260613ModalFeatures: FC = () => (
  <div className="d-flex flex-column gap-4">
