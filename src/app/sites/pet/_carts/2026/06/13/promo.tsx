...
import { Hero20260613 } from './hero';
import { Pet20260613Modal } from './modal';
...
export const Pet20260613Promo: FC<Props> = ({ date, period }) => {
