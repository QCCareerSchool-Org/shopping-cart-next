...
import { Pet20250225Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#f23943';
...
export const Pet20250225Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Pet20250225Modal show={showPopup} onHide={handleClick} />
