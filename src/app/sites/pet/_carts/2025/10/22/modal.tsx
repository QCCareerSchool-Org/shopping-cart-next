...
export const Pet20251022Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>Our Black Friday offer is here early! For a limited time, enroll in any pet course and save an additional {discount} on tuition.</p>
        <hr />
