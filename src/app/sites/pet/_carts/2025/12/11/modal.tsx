...
export const Pet20251211Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, you can enroll in any pet care course and save {discount} on tuition, or save even more when you pay in full.</p>
        <hr />
