...
import { Hero20260318 } from './hero';
import { Wellness20260318Modal } from './modal';
...
export const Wellness20260318Promo: FC<Props> = ({ date, period }) => {
