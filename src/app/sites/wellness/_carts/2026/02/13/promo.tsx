...
import { Wellness20260213Modal } from './modal';
...
export const Wellness20260213Promo: FC<Props> = ({ date, promotionPeriod }) => {
  ...
  return (
    <>
      ...
      <Wellness20260213Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
