...
export const Wellness20251022Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Start Your Sleep Consulting Career in Under 3 Months</Modal.Header>
      <Modal.Body>
        <p>Our Black Friday Offer is here early! For a limited time, enroll in Sleep Consulting and get {discount} off your tuition.</p>
        <hr />
