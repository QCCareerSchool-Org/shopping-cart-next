...
import { Wellness20251211Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#010510';
...
export const Wellness20251211Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Wellness20251211Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
