  ...
  return (
    <div className="row d-flex align-items-center">
      <div className="col-12 col-md-6 text-center text-md-end mb-3 mb-md-0">
        <button type="button" className="btn btn-link p-0 btn-no-hover-shadow" onClick={handleClick}><Image src={TwentyOneDays} width="97" height="100" className="img-fluid" alt="14-Day Money-Back Guarantee" /></button>
      </div>
