  ...
  return (
    <header style={{ backgroundColor }}>
      <div className="container py-3 py-sm-4">
        <div className="row">
          <div className="col-9 col-sm-12 text-start text-sm-center"><a href="https://www.qceventplanning.com/"><Image src={Logo as StaticImageData} priority className="img-fluid" alt="QC Event School" style={{ height: 30 }} /></a></div>
