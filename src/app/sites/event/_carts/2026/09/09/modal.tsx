...
export const Event20260909Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Event20260909ModalHeading />}
    left={<Event20260909ModalLeft />}
    right={<Event20260909ModalRight />}
    headerAside={<Event20260909ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$75</span>.</>}
  />
);

const Event20260909ModalHeading: FC = () => (
...
const Event20260909ModalOffer: FC = () => (
...
const Event20260909ModalLeft: FC = () => (
  <div>
...
const Event20260909ModalRight: FC = () => (
  <>
    <Event20260909ModalFeatures />
...
const Event20260909ModalFeatures: FC = () => (
