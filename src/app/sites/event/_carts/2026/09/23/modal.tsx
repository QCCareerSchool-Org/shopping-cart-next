...
export const Event20260923Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
    heading={<Event20260923ModalHeading />}
    left={<Event20260923ModalLeft />}
    right={<Event20260923ModalRight />}
    headerAside={<Event20260923ModalOffer />}
    footerMessage={<>Start your journey today for only <span className="text-primary">$75</span>.</>}
  />
);

const Event20260923ModalHeading: FC = () => (
...
const Event20260923ModalOffer: FC = () => (
...
const Event20260923ModalLeft: FC = () => (
  <div>
...
const Event20260923ModalRight: FC = () => (
  <>
    <Event20260923ModalFeatures />
...
const Event20260923ModalFeatures: FC = () => (
