...
import { Event20260814Modal } from './modal';
...
export const Event20260814Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Event20260814Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
