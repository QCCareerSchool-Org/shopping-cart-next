...
import { Event20260814Promo } from './promo';
...
export const Event20260814: FC<Props> = ({ date, period }) => (
  <>
    <Event20260814Promo date={date} period={period} />
    <Form
      date={date}
      ...
      dynamicCourseMessages={[ TwoFreeEventSpecialtyEDDynamicMessage, Save50CourseMessage ]}
    />
  </>
);
