...
import { Event20260826Modal } from './modal';
...
export const Event20260826Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Event20260826Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
