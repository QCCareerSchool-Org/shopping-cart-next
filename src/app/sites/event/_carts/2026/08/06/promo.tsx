...
import { Event20260806Modal } from './modal';
...
export const Event20260806Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Banner onClick={handleClick} badgeImageSrc={null} hideLink>
        FLASH OFFER: Save an extra <strong>50% Off Each Additional Course</strong>
      </Banner>
      <Event20260806Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
