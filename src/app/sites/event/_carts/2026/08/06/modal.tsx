...
export const Event20260806Modal: FC<Props> = props => (
  <PromoModal
    show={props.show}
    onHide={props.onHide}
...
const Event20260506ModalHeading: FC = () => (
  <div className="position-relative z-1 flex-grow-1">
    ...
    <p className="text-secondary mb-0">Enroll in any foundation course and get two specialty courses FREE, plus save $100!</p>
  </div>
);
...
const Event20260506ModalFeatures: FC = () => (
