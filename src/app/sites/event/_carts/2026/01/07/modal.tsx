...
export const Event20260107Modal: FC<Props> = props => {
  const priceState = usePriceState();

  const discount = priceState?.currency.code === 'GBP' ? '£100' : '$100';
  return(
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Take Control of Your Future in Event Planning</Modal.Header>
      <Modal.Body>
        <p>A new year means new opportunities&mdash;and now&apos;s your moment to act. For a limited time, enroll in any foundation course and get <strong>2 FREE specialty courses</strong>, plus {discount} OFF your tuition.</p>
        <hr />
