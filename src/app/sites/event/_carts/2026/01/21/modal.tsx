...
export const Event20260121Modal: FC<Props> = props => {
  ...
  return(
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>A new year means new opportunities&mdash;and now&apos;s your moment to act. For a limited time, enroll in any foundation course and get a <strong>FREE second course</strong>, plus {discount} OFF your tuition.</p>
        <hr />
