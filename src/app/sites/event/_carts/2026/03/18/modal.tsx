...
export const Event20260318Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton>Become a Certified Expert in less than 3 months!</Modal.Header>
    <Modal.Body>
      <p>This is your moment to invest in your future. For a limited time, enroll in any foundation course and get <strong>2 FREE specialty courses PLUS $100 OFF tuition</strong>.</p>
      <hr />
