...
import { Hero20260603 } from './hero';
import { Event20260603Modal } from './modal';
...
export const Event20260603Promo: FC<Props> = ({ date, period }) => {
