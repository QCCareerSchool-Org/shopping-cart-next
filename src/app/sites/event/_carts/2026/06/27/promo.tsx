...
import { Event20260627Modal } from './modal';
...
export const Event20260627Promo: FC<Props> = ({ date, period }) => {
  ...
  return (
    <>
      ...
      <Event20260627Modal show={showPopup} onHide={handleClick} />
    </>
  );
};
