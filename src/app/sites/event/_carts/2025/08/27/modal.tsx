...
export const Event20250827Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    <Modal.Header closeButton>Start Your Event Planning Career</Modal.Header>
    <Modal.Body>
      <p>For a limited time, enroll in any foundation course and get 2 FREE specialty courses, PLUS an extra $100 off tuition! This is the perfect opportunity to become a certified expert.</p>
      <hr />
