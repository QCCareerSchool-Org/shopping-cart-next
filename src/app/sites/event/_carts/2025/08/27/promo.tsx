...
import { Event20250827Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#4d2d1d';
...
export const Event20250827Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Event20250827Modal show={showPopup} onHide={handleClick} />
