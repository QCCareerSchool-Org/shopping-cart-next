...
export const Event20250327Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any course and get a second course FREE plus {discount} off your tuition! This is the perfect opportunity to become a certified expert.</p>
        <hr />
