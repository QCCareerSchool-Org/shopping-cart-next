...
export const Event20250701Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in a foundation course and get a second course FREE, plus an extra {discount} OFF your tuition! This is the perfect opportunity to become a certified expert.</p>
        <hr />
