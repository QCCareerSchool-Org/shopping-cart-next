...
export const Event20250723Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any course and get a free second course, plus an extra {discount} off tuition! This is the perfect opportunity to become a certified expert.</p>
        <hr />
