...
export const Event20250723Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    ...
    <Modal.Body>
      <p>For a limited time, enroll in a foundation course and get two free specialty courses FREE! This is the perfect opportunity to become a certified expert.</p>
      <hr />
