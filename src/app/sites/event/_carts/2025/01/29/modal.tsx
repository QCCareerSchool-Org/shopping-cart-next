...
export const Event20250129Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any foundation course and get two free specialty courses PLUS {discount} off your tuition! This is the perfect opportunity to specialize in your event planning training and become a certified expert.</p>
        <hr />
