...
import { Event20250416Modal } from './modal';
import { CountDownTimerWrapper } from '@/components/countDownTimer/countDownTimerWrapper';
import { Section } from '@/components/section';
import { useToggle } from '@/hooks/useToggle';

const backgroundColor = '#aaacad';
...
export const Event20250416Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Event20250416Modal show={showPopup} onHide={handleClick} />
