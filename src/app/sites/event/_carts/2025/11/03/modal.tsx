...
export const Event20251103Modal: FC<Props> = props => {
  return(
    <Modal show={props.show} onHide={props.onHide}>
      <Modal.Header closeButton>Start Your Event Planning Career</Modal.Header>
      <Modal.Body>
        <p>For a limited time, enroll in any course and get a second course PLUS Virtual Event Training FREE! This is the perfect opportunity to become a certified expert.</p>
        <hr />
