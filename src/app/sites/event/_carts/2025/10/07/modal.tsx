...
export const Event20251007Modal: FC<Props> = props => (
  <Modal show={props.show} onHide={props.onHide}>
    ...
    <Modal.Body>
      <p>For a limited time, enroll in any foundation course and get a FREE specialty course, PLUS an extra $100 off tuition! This is the perfect opportunity to become a certified expert.</p>
      <hr />
