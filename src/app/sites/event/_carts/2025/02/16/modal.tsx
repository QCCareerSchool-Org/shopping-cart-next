...
export const Event20250216Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any course and get two free specialty courses free + {discount} off your tuition! This is the perfect opportunity to specialize in your event planning training and become a certified expert.</p>
        <hr />
