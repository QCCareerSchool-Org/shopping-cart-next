...
export const Event20241007Modal: FC<Props> = props => {
  ...
  return (
    <Modal show={props.show} onHide={props.onHide}>
      ...
      <Modal.Body>
        <p>For a limited time, enroll in any foundation course and <strong>get a free second course</strong> and {discount} off your tuition! This is the perfect opportunity to specialize in your event planning training and become a certified expert.</p>
        <hr />
