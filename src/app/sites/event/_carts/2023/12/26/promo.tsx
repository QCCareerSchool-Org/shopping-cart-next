...
export const Event20231226Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <Modal show={showPopup} onHide={handleClick}>
        ...
        <Modal.Body>
          <p className="lead mb-0">For a limited time, enroll in any foundation course and get TWO specialty courses free!</p>
        </Modal.Body>
      </Modal>
