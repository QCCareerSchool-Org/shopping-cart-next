...
import { EventStudent20240724Modal } from './modal';
...
export const EventStudent20240724Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240724Modal show={showPopup} onHide={handleClick} />
