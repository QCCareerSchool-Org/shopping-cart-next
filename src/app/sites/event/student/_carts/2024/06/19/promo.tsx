...
import { EventStudent20240619Modal } from './modal';
...
export const EventStudent20240619Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240619Modal show={showPopup} onHide={handleClick} />
