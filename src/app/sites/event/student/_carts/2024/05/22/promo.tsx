...
import { EventStudent20240522Modal } from './modal';
...
export const EventStudent20240522Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240522Modal show={showPopup} onHide={handleClick} />
