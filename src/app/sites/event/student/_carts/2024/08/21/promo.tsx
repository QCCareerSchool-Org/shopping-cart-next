...
import { EventStudent20240821Modal } from './modal';
...
export const EventStudent20240821Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240821Modal show={showPopup} onHide={handleClick} />
