...
import { EventStudent20240222Modal } from './modal';
...
export const EventStudent20240222Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240222Modal show={showPopup} onHide={handleClick} />
