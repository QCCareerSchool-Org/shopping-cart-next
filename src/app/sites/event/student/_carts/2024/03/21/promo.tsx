...
import { EventStudent20240321Modal } from './modal';
...
export const EventStudent20240321Promo: FC<Props> = ({ date }) => {
  ...
  return (
    <>
      ...
      <EventStudent20240321Modal show={showPopup} onHide={handleClick} />
