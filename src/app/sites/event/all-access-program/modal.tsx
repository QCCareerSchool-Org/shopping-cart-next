    ...
    <div className="bg-light w-100 d-flex flex-column overflow-hidden rounded-5">
      ...
      <div className="bg-white border-top p-4 px-xl-5 flex-shrink-0 d-flex flex-column flex-lg-row align-items-center justify-content-between w-100 z-1 gap-4">
        ...
        <div className="d-flex flex-column flex-sm-row gap-3">
          <button className={`btn bg-white fw-bold ${styles['text-dark-blue']}`} style={{ border: '1px solid #e2e8f0', padding: '0.6rem 1.5rem', borderRadius: '0.5rem' }}>View Payment Plans</button>
          <button className="btn btn-primary fw-bold" style={{ padding: '0.6rem 1.5rem', borderRadius: '0.5rem' }}>Enroll Now</button>
        </div>
      </div>
